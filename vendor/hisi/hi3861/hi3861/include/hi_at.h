...
typedef struct {
    hi_char *at_cmd_name;  //AT 指令名称
    hi_s8   at_cmd_len;   //指令长度
    at_call_back_func at_test_cmd;  //指令测试回调函数
    at_call_back_func at_query_cmd;  //指令查询回调函数
    at_call_back_func at_setup_cmd;  //指令设置回调函数
    at_call_back_func at_exe_cmd;  //指令执行回调函数
} at_cmd_func;
