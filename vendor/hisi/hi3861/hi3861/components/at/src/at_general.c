...
//AT+MYTEST  执行回调函数
hi_u32 at_exe_mytest_cmd(void)
{
    hi_at_printf("AT+MYTEST running!\r\n");
    hi_at_printf("OK\r\n");
    return HI_ERR_SUCCESS;
}
...
const at_cmd_func g_at_general_func_tbl[] = {
    ...
    //添加自己的指令"AT+MYTEST"，"+MYTEST"长度为7，无测试、查询、设置功能。只有执行功用，回调函数为at_exe_mytest_cmd
    {"+MYTEST", 7, HI_NULL, HI_NULL, HI_NULL, (at_call_back_func)at_exe_mytest_cmd},
